...
import {
  OrderMealTableInterface,
  OrderMealTableResponse,
} from "../../../interfaces/OrderMealsTable";
...
const MealsTable = () => {
  ...
  const fetchMeals = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const data: OrderMealTableResponse = await getMealsTable(
          page,
          pageSize,
          period,
          sortModel
        ...
        setRows(
          data.content.map((orderMeal: OrderMealTableInterface) => ({
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: false,
      filterable: false,
      renderCell: (params: any) => params.value + " USD",
    },
    {
      field: "quantity",
      headerName: "Quantity",
    ...
    {
      field: "time",
      headerName: "Average meal prepare time",
      width: 180,
      sortable: false,
      filterable: false,
      renderCell: (params: any) => params.value + " min",
    },
  ];
