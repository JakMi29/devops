...
const MealCategoryContainer = ({
  handleChange,
  currentCategory,
}: MealCategoryContainerProps) => {
  return (
    <div className={classes.categoryContainer}>
      <button
        onClick={() => handleChange("appetizer")}
        className={`${uiClasses.blueButton} ${
          currentCategory === "appetizer" ? uiClasses.active : ""
        }`}
      >
        Appetizer
      </button>
      <button
        ...
        className={`${uiClasses.blueButton} ${
          currentCategory === "soup" ? uiClasses.active : ""
        }`}
      >
        Soup
      </button>
      <button
        ...
        className={`${uiClasses.blueButton} ${
          currentCategory === "main_dish" ? uiClasses.active : ""
        }`}
      >
        Main dish
      </button>
      <button
        ...
        className={`${uiClasses.blueButton} ${
          currentCategory === "dessert" ? uiClasses.active : ""
        }`}
      >
        Dessert
      </button>
      <button
        ...
        className={`${uiClasses.blueButton} ${
          currentCategory === "drink" ? uiClasses.active : ""
        }`}
      >
        Drink
      </button>
      <button
        ...
        className={`${uiClasses.blueButton} ${
          currentCategory === "alcoholic_drink" ? uiClasses.active : ""
        }`}
      >
        Alcoholic drink
      </button>
