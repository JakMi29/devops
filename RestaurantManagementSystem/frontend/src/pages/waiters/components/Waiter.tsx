...
function Waiter({
  ...
  return (
    <Paper elevation={3} sx={{ padding: 1, textAlign: "center", gap: "10px" }}>
      ...
      <Typography variant="body2">Email: {waiter.email}</Typography>
      <Typography variant="body2">Salary: {waiter.salary} USD</Typography>
      ...
      <div className={classes.actions}>
        ...
        <div style={{ display: "flex", gap: "20px" }}>
          ...
          <button className={uiClasses.blueButton}>Statistics</button>
        </div>
      </div>
    </Paper>
  );
